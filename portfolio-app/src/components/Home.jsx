    ...
    return (
        <div>
            ...
            <div className='w-screen h-screen flex justify-center'>
                ...
                <div className='grid  md:grid-cols-4 gap-12 justify-center items-center w-full h-2/3 px-8'>
                    <div className='card w-full h-1/3'>
                        <h1 className='mb-12 align-top flex justify-center text-2xl text-silver font-Oswald'>Languages</h1>
                    ...
                    <div className='card w-full h-1/3'>
                        <h1 className='mb-8 align-top flex justify-center text-2xl text-silver font-Oswald'>FrameWorks</h1>
                    ...
                    <div className='card w-full h-1/3'>
                        <h1 className='mb-12 align-top flex justify-center text-2xl text-silver font-Oswald'>Dev Tools</h1>
                    ...
                    <div className='card w-full h-1/3'>
                        <h1 className='mb-10 align-top flex justify-center text-2xl text-silver font-Oswald'>Learning</h1>
                        <div className='flex  justify-center gap-4'>
            ...
            <div className=' h-screen w-screen px-8 pt-7'>
                <h1 ref={myRef} className=' text-silver flex justify-center text-4xl font-Oswald'>Projects</h1>
                ...
                <div className='flex gap-6 mt-10 justify-end items-center'>
                <div className='w-2/3 h-2/3 flex flex-col border-2 bg-sea'>
                <h1 className='flex justify-center underline font-bold text-silver mt-3 font-Oswald'>Movie Trivia</h1>
                    <h1 className='min-w-full min-h-full flex mt-3 px-4 text-silver font-Oswald'>Movie Trivia was my first project utilizing Javascript and HTML/CSS. Movie Trivia is a trivia game based off the movie The Matrix. Movie Trivia was a great way for me to learn some game logic and provided a fantastic challenege for my first project. Through DOM manipulation I was able to get a light/dark mode working, and through CSS was able to create a typewriter effect for users to see when the app loads.</h1>
            ...
            <div className='h-screen w-screen px-4'>
                ...
                <h1 ref={myRef2} className='flex justify-center text-silver text-4xl font-Oswald'>Contact Me!</h1>

                <div className='flex justify-center text-3xl text-silver '>
                    <h1 className='font-Oswald'>Now that you've seen my portfolio, click below and let's connect!</h1>
                </div>
